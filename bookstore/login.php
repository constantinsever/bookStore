    ...
    <tr>
      <td colspan="4" align="center" valign="middle" nowrap="nowrap" class="arial_bold">
	    ...
	    <table width="200" border="1" cellpadding="5" cellspacing="0" bordercolor="#999999">
          <tr>
            <td bgcolor="#CCCCCC">Intra in cont  </td>
          </tr>
          <tr>
            <td>
   	 		 <form action="login_exec.php" method="POST">			
			 <table width="476" height="83" border="0">
              <tr>
                <td width="108"><label>Utilizator</label></td>
                <td width="172"><input type="text" name="username" /></td>
                <td align="center" nowrap="nowrap"><a href="javascript: void(0)" onclick="document.forms[1].submit()">Login</a></td>
                </tr>
              <tr>
                <td><label>Parola</label></td>
                <td><input type="password" name="password" /></td>
                <td align="center" nowrap="nowrap"><a href="javascript: void(0)" onclick="document.location='recuperare_pass.html'">Recuperare parola </a></td>
                </tr>
            </table>
			 </form>			</td>
          </tr>
